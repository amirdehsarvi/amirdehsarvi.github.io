...
<div class="section section--experience">
    ...
    <div>
<ul>
<li><b>2025 to date:</b> Principal Scientist Neuroimaging, <a href="https://www.boehringer-ingelheim.com">Boehringer Ingelheim</a> (Germany).</li>
...
<li><b>2022-2025:</b> Postdoctoral Researcher, The Institute for Stroke and Dementia Research (ISD), Ludwig-Maximilians-Universität München (LMU), University of Munich (Germany).
    <ul>
        ...
        <li>Managed the High-Performance Computing (HPC) resources and supported research labs with their data analysis needs on the HPC, in addition to serving as an IT assistant for the LMU Hospital.</li>
    </ul>
</li>
...
<li><b>2014-2018:</b> PhD Electronic Engineering, University of York (UK).
    <ul>
        <li>Supervision: <a href="https://www.york.ac.uk/physics-engineering-technology/people/stephen_smith/">Professor Stephen Smith</a>.</li>
